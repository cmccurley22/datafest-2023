...
df_question_data <-
  ...
  subset(select = -c(Id.x, Id.y, CategoryUno, SubcategoryUno, AskedOnUtc, TakenOnUtc, ClosedOnUtc, LegalDeadline, CreatedUtc))
...
df_client_state_data <-
  ...
  subset(select = -c(Id.x, Id.y, PostalCode, CreatedUtc))
